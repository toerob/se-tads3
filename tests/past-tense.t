...
UnitTest 'playerActionMessages' run {
    ...
    local pairs = [
      ...
      &cannotDigMsg -> 'Du hade ingen anledning att gräva i den.',
      &cannotDigWithMsg -> 'Du såg inget sätt att använda den som en spade.',
...
UnitTest 'npcActionMessages' run {
    ...
    local pairs = [
      ...
      &cannotDigMsg -> 'Bob hade ingen anledning att gräva i den.',
      &cannotDigWithMsg -> 'Bob såg inget sätt att använda den som en spade.',
