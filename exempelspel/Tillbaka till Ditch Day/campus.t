...
myWallet: BagOfHolding, Openable, RestrictedContainer
    'brun läder+plånbok+en/börs+en' 'plånbok'
...
+ alumniID: WalletItem 'alumni+kort+et/id+kort+et/identifikation^s+kort+et/alumn+kort+et' 'alumni ID-kort'
    "Detta kort identifierar dig som en Caltech-alumn. "
    owner = me
;

+ cxCard: WalletItem 'consumer express cumex företag:et^s+kredit:en+kort+et/kredit:en+kort+et'
...
+ driverLicense: WalletItem
    'kalifornien körkort+et/förarbevis+et/foto+t/fotografi+et'
    'körkort'
    "Detta är ditt kaliforniska körkort, komplett med ögonen-stängda
    foto. "
    owner = me
;
 ...
 *   contents.  
 */
toteBag: BagOfHolding, Wearable, ComplexContainer 'axel+väska+n/tyg+kasse+n' 'tygkasse'
...
;
+ Component '(tyg) (kasse) vadderad+e axelrem+men' 'axelrem'
...
+ Readable 'snabbreferens+en karriärcenter kontor+et information:en^s+blad+et'
    ...
    Detta är en snabbreferens för att hjälpa till att säkerställa att ditt besök blir smidigt och
    produktivt.
    ...
    dobjFor(ConsultAbout)
    {
        ...
        action()
        {
            ...
            if (!dst.isInGame)
                ...
                fokusera på uppgiften du har för handen. ";
            ...
            else if (path != nil)
            {
                ...
                /* show the path */
                "För att ta sig dit härifrån, så skulle du gå ";
...
DabneyMapEntry '1 alley one' 'Alley Ett'
    "norr om arkadgången, som är precis väster om innergården"
;
DabneyMapEntry '2 alley two' 'Alley Två'
    "en trappa upp från Alley Ett"
;
DabneyMapEntry '3 alley three' 'Alley Tre'
    "precis vid innergården, åt sydväst"
;
DabneyMapEntry '4 alley four' 'Alley Fyra'
    "en trappa upp från Alley Tre"
;
DabneyMapEntry '5 alley five' 'Alley Fem'
    "precis vid innergården, åt sydost"
;
DabneyMapEntry '6 alley six' 'Alley Sex'
    "en trappa upp från Alley Fem"
;
DabneyMapEntry '7 upper lower alley seven' 'Alley Sju'
    "en trappa upp från innergården"
;
DabneyMapEntry 'courtyard' 'innergården'
    "i mitten av huset, precis innanför Orange Walk"
;
DabneyMapEntry 'lounge' 'sällskapsrummet'
    "precis vid innergården, åt öster"
;
DabneyMapEntry 'dining room' 'matsalen'
 ...
 *   asked for a route.  
 */
CampusMapEntry 'alles lab/laboratory' 'Alles Laboratorium' 'sydväst';
CampusMapEntry 'alumni house' 'Alumnihuset' 'nordost';
CampusMapEntry 'arms lab/laboratory' 'Arms Laboratorium' 'sydväst';
CampusMapEntry 'avery center' 'Avery Center' 'norr';
CampusMapEntry 'baxter hall' 'Baxter Hall' 'norr';
CampusMapEntry 'beckman institute' 'Beckmaninstitutet' 'nordväst';
...
CampusMapEntry 'central plant' 'Centrala Anläggningen'
    "Den ligger på södra sidan av California Blvd. ";
CampusMapEntry 'chandler dining hall' 'Chandler Matsal' 'öst';
CampusMapEntry 'church lab/laboratory' 'Church Laboratorium' 'sydväst';
CampusMapEntry 'crellin lab/laboratory' 'Crellin Laboratorium' 'sydväst';
CampusMapEntry '(dabney) hall/humanities' 'Dabney Hall' 'sydväst'
    desc = "Förvirrande nog har campus två byggnader som heter
        ...
        <.p><<inherited>>"
;
CampusMapEntry '(dabney) gardens' 'Dabney Gardens' 'sydväst';
CampusMapEntry '(holliston) parking structure'
    'Holliston parkeringshus' 'nordost';
...
CampusMapEntry 'karman lab/laboratory' 'Karman Laboratorium' 'söder';
CampusMapEntry 'keck lab/laboratories' 'Keck Laboratorier' 'centralt';
...
CampusMapEntry 'marks house' 'Marks House' 'öst';
CampusMapEntry 'mead lab/laboratory' 'Mead Laboratorium' 'nordväst';
CampusMapEntry 'mechanical universe' 'det Mekaniska Universumet' 'nordost';
CampusMapEntry 'project mathematics' 'Projekt MATEMATIK!' 'nordost';
CampusMapEntry 'moore lab/laboratory' 'Moore Laboratorium' 'norr';
...
CampusMapEntry 'noyes lab/laboratory' 'Noyes Laboratorium' 'nordväst';
...
CampusMapEntry 'public relations' 'PR-avdelningen' 'nordost';
...
CampusMapEntry 'spalding lab/laboratory' 'Spalding Laboratorium' 'söder';
CampusMapEntry 'steele house' 'Steele House' 'nordost';
CampusMapEntry 'steele lab/laboratory' 'Steele Laboratorium' 'norr';
CampusMapEntry 'theater arts/tacit' 'Teaterkonst' 'nordost';
...
pasSky: defaultSky
    vocabWords = '(klar) (blå) orange-brun disig smog/dis'
    desc()
    {
        /* 
...
sanPasqual: Street, CampusOutdoorRoom 'San Pasqual St.' 'San Pasqual'
    ...
    vocabWords = 'san pasqual st./gata'
    isProperName = true
...
+ CampusMapEntry 'san pasqual st./gata' 'San Pasqual St.' 'nordost';

+ Decoration 'parkerad bil/bilar' 'parkerade bilar'
...
+ spHolliston: Street, PathPassage
    's. s söder holliston ave./avenue' 'Holliston'
...
+ Decoration 'åtta fot hög betong hög north house houses
    buske/buskar/mur/komplex' 'mur'
...
+ CampusMapEntry '(physical) (plant) verkstad'
    'Physical Plants verkstad' 'nordost';
+ CampusMapEntry 'studentservice karriärcenter kontor byggnad/(kontor)'
    'Studentservice' 'nordost';
+ CampusMapEntry 's. s söder holliston ave./avenue'
...
+ Fixture 'baksida physical plant verkstad (lastning) butik/(kaj)/(kajer)/sida'
    'verkstad'
    "Det enda som syns på denna sida av verkstaden är
    lastkajerna. Inga lastbilar lastar just nu, så alla
    rullportar är stängda. "
;
++ Decoration 'lastkaj kajer (physical) (plant) (verkstad)
    rull rull port/portar' 'lastkajsportar'
    "Lastkajsportarna är alla stängda. "
    isPlural = true
;

+ EntryPortal ->cssLobby 'studentservice byggnad/ingång/center'
...
cssLobby: Room 'Studentservice Lobby' 'Studentservice lobbyn' 'lobby'
    ...
    ger lite glädje åt denna lilla lobby. Flera dörrar
    ...
    vocabWords = 'studentservice lobby'
...
+ cssDoorN: AlwaysLockedDoor
    '"kontor för forskarstudier" kontor forskarstudier norr n dörr+en*dörrar+na'
    'norra dörren'
    "Den är märkt <q>Kontor för forskarstudier.</q> "
;

+ cssDoorE: AlwaysLockedDoor
    '"studentärenden" studentärenden öst ö dörr+en*dörrar+na' 'östra dörren'
    "Den är märkt <q>Studentärenden.</q> "
;

+ cssDoorS: Door
    '"karriärcenter kontor" karriärcenter kontor söder s dörr+en*dörrar+na'
    'södra dörren'
...
+ CampusMapEntry 'jorgensen lab/laboratorium'
...
ppOffice: Room 'Physical Plant Kontor' 'Physical Plant Kontoret'
    ...
    vocabWords = 'physical plant kontor'
...
+ ppoHall: OutOfReach, ThroughPassage 'hall+en/korridor+en' 'korridor'
    ...
    dobjFor(TravelVia)
    {
        ...
        check()
        {
            "Du måste anta att området bakom disken är
...
jorgensen: Room 'Jorgensen Lobby' 'lobbyn i Jorgensen' 'lobby'
    ...
    vocabWords = 'jorgensen lab/laboratorium/lobby'
...
jorgensenHall: Room 'Korridor' 'korridoren'
    ...
    vocabWords = 'jorgensen hall/korridor/lab/laboratorium'
...
+ jhPrivateDoor: ForbiddenDoor
    'privat kontor dörr+en*dörrar+na' 'privata kontorsdörrar'
...
networkOffice: Room 'Nätverkskontor' 'Nätverkskontoret' 'kontor'
    ...
    vocabWords = 'campus nätverk kontor'
...
+++ AskTellTopic, StopEventList [quadWorkers, nicTopic]
    ...
    dig och mig, jag tror ärligt talat att de latar sig något fruktansvärt.</q><.reveal dave-suspects-nic> ',
     ...
     <.p><q>Ja, man kan säga det,</q> säger han. <q>Jag kommer att
     behöva gräva lite djupare vid något tillfälle.</q> ']
;
...
++++ AltTopic
    ...
    frågar du.
    <.p>Han kontrollerar pärmen igen. <q>Låt se. Här är det.
...
+++ AskTellGiveShowTopic @netAnalyzer
    ...
    tomma intet en stund. <q>Ja, jag har använt dem, men jag är
    ledsen att säga att jag inte kan komma ihåg det minsta om dem.
...
+ cherryPicker: Heavy, Vehicle
    ...
    travelerTravelTo(dest, connector, backConnector)
    {
        ...
        {
            /* explain the problem */
            "Du gör bäst i att behålla skyliften utomhus. ";
...
class GuntherJobCardTopic: GiveShowTopic
    topicResponse()
    {
        ...
        {
            "<q>Vad ser ut som att jag redan arbetar på här,
...
+++ Component '(skylift) (vagn) ikonisk
...
+ CustomImmovable
    ...
    dobjFor(Enter)
    {
        ...
        action() { "Om du skulle gissa, skulle du säga att arbetarna tejpade av området
            för att hålla personer som du ute. "; }
    }
;
+ OutOfReach, SecretFixture
...
++ quadAnalyzer: Thing
    ...
    dobjFor(Take)
    {
        ...
        check()
        {
            ...
            uppenbarligen är menad att hålla personer som du ute. För det andra
...
;
+++ Door '(brunn) brunn^s+metall+dörr+en/dörrar+na'
    'brunndörrar'
...
;
++ quadWorkers: Person
    'stora tunga ovårdade arbetare/man/skägg/skägg*män' 'arbetare'
...
;
+++ InitiallyWorn 'ljusgrön+a hård overaller+na/skyddshjälmar+na/uniformer+na/hjälmar+na'
    'uniformer'
...
+++ InConversationState, StopEventList
    [
        '<.p>En arbetare knuffar lekfullt den andre med armbågen. <q>Hej,
        vet du vad som är kul? Plisnik är rädd för råttor. Kolla
        på det här.</q> Han kupar händerna och ropar ner i schaktet. <q>Hej,
        ...
        '<.p><q>Hej,</q> säger en av arbetarna till den andre, <q>hur
        ...
        <q>Vad är jag, en leveransservice?</q> klagar han och
    ...
    stateDesc = "Båda tittar på dig---inte direkt förväntansfullt; 
            mer som om du precis gjorde något idiotiskt och de undrar 
...
++++ AskTellTopic [plisnikTopic, ratTopic]
    ...
    schaktet, <q>Hej, Plisnik! Jag tror jag ser en till råtta!</q>
...
oliveWalk: CampusOutdoorRoom
    ...
    vocabWords = 'östra ö olivgången gångväg'
    ...
    cherryPickerSpecialDesc = "En skyliftare är parkerad bredvid
        kanonen. "
;
...
+ Fixture, Chair, ComplexContainer
    ...
    {
        '(kanon) pipa/mynning' 'kanonens pipa'
    ...
    dobjFor(SitOn)
    {
        action()
        {
            ...
            upp på vagnen och sätt dig grensle över tunnan";
            inherited();
        }
    }
 ...
 *   den spelens Ditch Day-stack 
 */
++ mrHappyGear: Hidden
    'herr glad glad-ansikte metall maskin+kugghjul+et/ansikte+t/
...
athDiningRoom: Room 'Athenaeum Matsal' 'Ath-matsalen'
    ...
    vocabWords = 'rymlig ath athenaeum matsal rum'
...
+ Decoration
    ...
    isPlural = true
;
++ Decoration '(stig) glödlampa+n*glödlampor+na' 'stiglampor'
...
+ orwNorthWalk: PathPassage
    'norra n asfalterad stig/steg/trappsteg/trappa/trappor' 'trappsteg'
...
syncLot: CampusOutdoorRoom 'Sync-parkeringen' 'Sync-parkeringen' 'parkeringsplats'
    ...
    vocabWords = '(sync) (synkrotron) parkering parkeringsplats'
...
+ syncDoor: LockableWithKey, Door
    'matt+a (sync) (synkrotron) (lab) (laboratorium) metall+dörr+en'
    'matt metalldörr'
    ...
    inCherryPickerSpecialDesc = "Du står i korgen på en
        ...
        <<cherryPickerBasket.isRaised
          ? "Botten av det spjälliknande gallret är inom räckhåll
            från korgen." : "">> "
    cherryPickerSpecialDesc = "En skyliftare är parkerad intill
        Firestone. "
...
+ firestoneDoor: AlwaysLockedDoor
    ...
    cannotOpenLockedMsg = 'Dörren verkar vara låst. Säkerhetspersonalen måste
        inte ha brytt sig om att låsa upp byggnaden idag, eftersom de visste att
        de flesta lektioner skulle ställas in för Ditch Day. '
;

+ guggenheimDoor: AlwaysLockedDoor
    'främre trä (guggenheim) (guggenheim)/dörr+en*dörrar+na' 'dörren till Guggenheim'
...
+ cfUp: TravelWithMessage, StairwayUp ->frGrill
    travelDesc = "Du arbetar dig upp till toppen av väggen. Så snart du är på toppen, rullar du dig över kanten till taket. "
...
guggenheimRoof: RoofRoom
    ...
    vocabWords = 'guggenheim lab/laboratorium/byggnad/(tak)'

    east = firestoneRoof
    south: NoTravelMessage { "Det finns ingen uppenbar ingång till
        konstruktionen här. Vilket inte är förvånande: du skulle förvänta dig att
        vindtunnelforskarna går in från insidan av Guggenheim, inte
...
++ grPanel: TravelWithMessage, Door ->wtPassage
    'åtkomst liten lilla låg+a panel+en/dörr+en/passage+n' 'liten panel'
...
windTunnelShaft: Room 'Botten av trappan' 'botten av trappan'
    ...
    vocabWords = 'smalt schakt/botten/(trappa)/(trappuppgång)'
...
thomasLobby: Room 'Thomas entréhall' 'Thomas entréhall' 'entréhall'
    ...
    vocabWords = 'thomas entréhall/thomas'
...
+ Fixture, Readable 'handskriven handskrivna skylt+en' 'skylt'
...
+ tlEastDoor: Door -> teWestDoor 'östra ö dörr+en/dörr+öppning+en*dörrar' 'östra dörr'
    "Dörren leder in i ett rum österut. En skylt tejpad på
    dörren lyder <q>Robottävling,</q> med en pil som pekar
    in i rummet. "
;

+ tlWestDoor: Door -> twEastDoor 'västra v dörr+en/dörr+öppning+en*dörrar' 'västra dörr'
...
thomasWest: Room 'Klassrum' 'klassrummet'
    ...
    vocabWords = 'klassrum/rum'

    east = twEastDoor
    out asExit(east)
;

+ twEastDoor: Door 'östra ö dörr+en/dörr+öppning+en' 'östra dörr'
    "Dörren leder ut österut. "
;
...
+ Fixture, Readable 'bred+a svart+a tavla+n' 'svarta tavlan'
    "Den svarta tavlan är lika bred som rummet. Den har några
...
class ObstacleItem: CustomImmovable
    cannotTakeMsg = 'Banan ser noggrant utlagd ut; du bör inte
        röra om i den. '
    ...
    iobjFor(PutIn)
    {
        ...
        {
            if (gDobj == toyCar)
                "Det skulle vara kul att köra bilen runt banan,
                men du borde förmodligen inte göra det; det skulle vara för lätt att knuffa
                delar ur position. ";
            else
                "<<cannotTakeMsg>>";
            exit;
...
ldCourtyard: CampusOutdoorRoom 'Lauritsen-Downs Innergård'
    ...
    vocabWords = '(lauritsen-downs) innergård'

    north = ldcNorthWalk
    northwest = ldEmergencyDoor

    south: FakeConnector { "Lauritsen-Downs är mestadels kontor och
        klassrum; med tanke på att det är Ditch Day, pågår det förmodligen inte
        mycket här idag. "; }
...
class ErnstJobCardTopic: GiveShowTopic
    topicResponse()
    {
        ...
        "Han slutar med det han höll på med och börjar packa ihop saker och omorganisera saker på sitt verktygsbälte. ";
...
rockGarden: CampusOutdoorRoom 'Stenträdgård' 'stenträdgården'
    ...
    västerut kan du se Millikan-biblioteket tornar upp sig. "
...
+ Enterable ->(location.west)
    'millikan niovånings obsidian svart bibliotek/torn/monolit'
