...
gameMain: GameMainDef
    ...
    {
               /* visa prologen */
        "\bÄn en gång har du, Doug Mittling, fått det usla
        reseuppdraget. Det är nackdelen med att vara mellanchef—
        dina ingenjörer var alla för upptagna med riktigt arbete,
        och din vice vd hade en viktig faktainsamlingsresa till
        Maui, men du hade ingen ursäkt förutom en stor hög med
        processrapporter att granska. Så här är du, på ett anonymt
        kraftverk i en mygginfesterad djungel någonstans i Sydostasien,
        närmaste flygplats tolv timmars bilresa bort. Du har varit
        här i sex veckor redan och försökt få den här usla SCU-1100DX
        att fungera så att du kan ge kunden en demo, men hittills är
        den fortfarande trasig. Det börjar kännas desperat, särskilt
        eftersom du har hört Guanmgon prata om Mitachron flera gånger
        nyligen. Om du förlorar det här kontraktet till Mitachron
        kommer din vice vd att bli rasande. När han kommer tillbaka
        från Maui, förstås.\b";
