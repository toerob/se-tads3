...
+ HintLongTopicItem 'Några Ord på Vägen'
    ...
    <q>klassiska</q> spel, så kanske du har fått intrycket att
    IF-författare känner en grym njutning av att förvirra spelare 
    och slumpmässigt döda huvudkaraktärer. Vissa gör säkert det, 
    men det här är inte den sortens spel.
    <.p>
    ...
    under spelets gång. Låt inte det skrämma dig---tänk bara
    ...
    Trek</i>. Du behöver ingen bakgrund i fysik för att spela spelet - 
    ...
    borde inte finnas något sätt att få spelet ovinnbart. Du behöver inte
...
++ goal772lv: Goal ->(scu1100dx.scoreMarker)
    ...
    ['Har du tittat noga på allting här?',
     ...
     '''Du ska föreställa en ingenjör, eller hur? Skulle en ingenjör
...
++ Goal 'Jag hittade Överste Magnxi. Vad gör jag nu?'
...
++ Goal '''Jag lyckas inte få Överste Magnxis uppmärksamhet.'''
    ['Du kanske bara måste försöka hårdare.',
    'Eller så kanske du bara måste försöka igen.',
    'Fortsätt att försöka prata med henne, så får du så småningom hennes uppmärksamhet.']
    openWhenSeen = adminLobby
    closeWhenAchieved = (magnxi.scoreMarker)
;
...
++ Goal 'Finns det ett sätt att undvika att fastna i hissen?'
    ...
    Du kan inte undvika att ta den, och du kan inte hindra den från att fastna,
...
++ Goal 'Hissen har fastnat. Vad gör jag nu?'
    ['Har du tittat dig omkring noggrant?',
     '''Grinden öppnas inte här, men det kanske finns en annan väg ut.''',
...
++ Goal '''Jag är ute ur hissen, men nu sitter jag fast i schaktet.'''
    ['Har du provat dörren?',
     ...
     något i springan. Det kanske finns något annat du
...
++ Goal 'Vad gör jag här på Caltech?'
...
++ Goal 'Finns det något sätt att få tag på Netbisco 9099?'
    ['Har du pratat med arbetarna än?',
     '''Fråga dem något, VÄNTA sedan i några omgångar. Du kommer att överhöra
     några saker som de säger till varandra.''',
     'Lägg märke till att de har en medarbetare nere i schaktet.',
     'Lägg märke till att de ibland räcker ner saker till sin medarbetare.',
     'Tittade du noga i schaktet?',
     ...
     'Om du bara skulle kunna göra dig av med Plisnik, kanske du kan 
     få arbetarna vid ytan att räcka dig nätverksanalysatorn.',
...
++ Goal 'Hur kommer jag förbi disken på Physical Plant-kontoret?'
    ['Försök minnas vad som fick dig att vilja komma in dit bakom.',
...
++ Goal 'Kan jag få trädgårdsmästaren att låta mig använda skyliften?'
    ['Du kan alltid försöka be honom om den.',
     '''Okej, han kommer inte ge dig den frivilligt. Har du varit
     ...
     uppmärksam på memon och såg till att inte några trädgårdsarbeten
     sammanföll med några elektriska arbeten. Men det finns en annan
     sak som du också ska undvika.''',
     'Du kanske kan få Gunther och Ernst att korsa varandras vägar på
     väg till sina nya jobb.',
     'Det skulle krävas lite omsorg med timingen, men du kanske kan få 
     dem båda att korsa Quad samtidigt.',
     'Har du lagt märke till att Ernst alltid tar lite tid på sig med att komma igång?',
     'Ernst tar tillräckligt lång tid på sig att komma igång att du kan skicka iväg honom
     till ett nytt jobb, och sedan omedelbart hitta igen Gunther och skicka iväg honom.
     Om du tajmar det rätt kommer de båda att nå Quad samtidigt.',
...
++ Goal 'Hur kan jag nå Guggenheims vindtunnel?'
    ['''Den är på taket av byggnaden. Men du verkar inte kunna
    komma in för att ta trapporn dit.''',
     '''Det kanske finns ett sätt att komma upp dit utan att gå in i
     byggnaden.''',
     ...
     'Det hör inte till ovanligheterna att folk ibland klättrar på det där gallerverket.',
     ...
     'Du behöver något som kan få upp dig tillräckligt högt för att nå
     gallret.',
     'Något som lyfter upp människor en liten bit ovanför marken.',
     '''Du bör utforska campusområdet lite mer om
     du inte har sett något som kan vara till hjälp.''',
     'Slå upp Beckman Auditorium på campuskartan och gå och titta dig omkring.',
     'Den där skyliften skulle kanske kunna vara till nytta.']
...
++ Goal 'Hur kommer jag in på Campus Network Office?'
    ['Läste du skylten?',
     ...
     borde klockan vara runt ett; kom tillbaka då.''']
...
++ Goal '''Vad är grejen med Mr.\ Happy Gear?'''
    ...
    den ursprungliga <i>Ditch Day Drifter</i>.''',
     ...
     för att lösa Skolkdagsstapeln i den ursprungliga <i>DDD</i>.',
...
++ Goal '''Vad är grejen med alla <q>Hovse</q>-felstavningar?'''
    ...
    Orange Walk?',
     ...
     för att se ut som inskriptionerna gör på klassiska romerska byggnader. 
     Det romerska alfabetet i klassiska tider hade inget U; V hade ungefär
     samma fonetiska värde av det moderna U. Så hovse-byggarna ersatte
...
++ Goal 'Hur kommer jag in i Sync-labbet?'
    ['''Du har tekniskt sett redan varit i Sync-labbet.''',
     ...
     '''Du har varit på taket av byggnaden. Det kanske finns en
     väg in därifrån.''',
...
++ Goal 'Hur korsar jag gapet i gångbron?'
    ...
    den vara ur funktion.''',
     ...
     '''Den är upphöjd från golvet något; du kanske bör titta
...
++ Goal 'Hur kommer jag in på kontoret?'
    ['Det ser ut som om du behöver en kombination för att öppna dörren.',
     '''Oroa dig inte så mycket om det där just nu; om du upptäcker
...
++ Goal '''Hur hittar jag personen jag ska intervjua?'''
    ['''Du ska ta dig till Career Center-kontoret först.
...
++ Goal 'Hur hittar jag Career Center-kontoret?'
    ...
    Holliston Avenue.',
     ...
     San Pasqual, österut från Holliston, och sen söderut från lobbyn.''']
...
++ Goal '''Vad handlar den här Skolkdagen-grejen om nu igen?'''
    ...
    utanför sina rum för att hålla dem yngre studenterna utanför.''']

    openWhenRevealed = 'stack-accepted'
    topicOrder = 100
;

++ Goal 'Vad bör jag göra?'
...
++ Goal 'Var är denna så kallade <q>stapel</q> som jag ska hitta?'
    ...
    din tygkasse?',
     'Du har en karta över campus, använd bara HITTA DABNEY HOUSE PÅ KARTAN.
...
++ Goal 'Hur får jag nyckeln från Erin?'
    ...
    men oroa dig inte: hon kommer inte att arbeta med stapeln alltför länge.
    Håll dig bara kvar i närheten av henne ett par rundor.']
...
++ Goal 'Hur listar jag ut vad <q>svarta lådan</q> gör?'
    ['Du samlade ihop testutrustningen, eller hur?',
     ...
     'Föreslår detta något annat du kan pröva?',
    ...
    du in oscilloskopet.',
     'Okej, så det löste inte stapeln direkt, men åtminstone gav det
    dig en idé om vad du kan göra härnäst.',
     'Du behöver läsa på lite bakgrundsinformation och få lite övning
    på att arbeta med kretsar.',
     'När du har gjort allt det, försök bara mäta med signalgeneratorn
...
++ Goal 'Var kan jag hitta en <q>bra ET-lärobok</q>?'
...
++ Goal 'Var kan jag få en rekommendation på en bra ET-lärobok?'
    ['Det kanske finns någon på campus som kan hjälpa.',
     ...
     'Om du är osäker på var de är, vandra bara runt på Dabney lite.',
...
++ Goal 'Var kan jag få lite övning på att felsöka kretsar?'
    ['Utforska Dabney lite; du kanske stöter på något.',
     'Kolla platserna nära innergården.',
     'Du letar efter någon slags elektronisk enhet i behov av reparation.',
     'Något som är ur funktion.',
     'Gå in i alkoven utanför innergården.',
     'Positron-spelet behöver repareras.',
...
++ Goal 'Var kan jag finna elektronisk testutrustning?'
    ['Läste du skylten på Brian Stamers dörr?',
    ...
    om du är osäker på hur du tar dig dit.)']
...
++ Goal 'Hur kan jag ta mig förbi röken i Gränd Ett?'
    ...
    medan du väntar på att branden ska släckas.',
     'Gå till Dabneys matsal och ät lite lunch.']
...
++ Goal 'Vad är en Hovarth-funktion?'
    ...
    förmodligen tillgänglig i biblioteket.',
...
++ Goal 'Hur beräknar jag det där Hovarth-numret?'
    ...
    på något vis.',
     ...
     'Detta bör nu ge dig några idéer om hur du ska kunna gå vidare.',
     ...
     men det kanske finns någon annan som skulle kunna hjälpa till.',
...
++ Goal 'Hur hittar jag Jay?'
    ['Har du varit till bokhandeln än?',
     ...
     'Jay befinner sig i Alley Four. Gå och fråga personerna där om honom.']
...
++ Goal 'Hur får jag Jay att hjälpa mig?'
    ['Först måste du förklara vad du vill att han ska göra.',
     ...
     'Kvantdatorer är lite svåra att förklara dock. 
     Du kanske ska låta honom läsa om dem själv.',
     'Ge Jay <i>Quantum Review Letters</i> nummer 73:9a.',
     'När han har läst klart kan du bara ge honom miniräknaren.',
...
++ Goal 'Jay programmerade miniräknaren; vad ska jag göra nu?'
...
++ Goal 'Okej, Stamers dörr är öppen; vad händer nu?'
    ['Det är tradition att gå in i seniorens rum efter att ha löst en stapel.
      Du tog dig ju trots allt igenom deras försvar.',
     'Gå bara in i rum 4.']
...
++ Goal 'Stamers labb är låst! Hur kommer jag in?'
    ...
    på en annan stapel. Du behöver bara använda den nyckeln.']
...
++ Goal 'Hur kommer jag in i monterskåpet?'
    ['Har du hittat larmsystemet än? Avbryt detta ledtrådsämne tills du har gjort det.',
     'Jag tyckte jag sa att du inte skulle fortsätta med detta 
     ledtrådsämne förrän du hade hittat larmsystemet!',
     'Okej då, det finns inget larmsystem. Faktum är, att du inte
     ens behöver ta dig in i monterskåpet.',
...
++ Goal 'Hur får jag tag på SPY-9-kameran?'
    ...
    vara intressant på andra sätt.',
     'Har du tittat noga på hur den är kopplad?',
     'Du kanske bör försöka lista ut vart kabeln går.']

    openWhenTrue = (spy9.described)
;

++ Goal 'Hur spårar jag kabeln från SPY-9-kameran?'
    ['Tittade du noggrant på den?',
     'Du borde leta upp kabelskåpet som nämndes när du tittade på
     kabeln.',
     ...
     'Detta föreslog ett sätt att identifiera kabeln.',
...
++ Goal 'Betyder etiketten på SPY-9-kabeln något?'
    ['Du behöver inte bekymra dig för detta på ett tag.']
...
++ Goal 'Vad betyder etiketten på SPY-9-kabeln?'
    ['Har du kollat dig omkring på Plisniks arbetsområde ännu?',
...
++ Goal 'Finns det något sätt att spåra kabeln bortom kabelskåpet?'
    ['Du märkte att den går in genom ett hål i norra väggen, eller hur?',
     ...
     vad du söker efter om du först går genom dörren och sedan 
     västerut.',
...
++ Goal 'Var kan jag hitta böckerna som listas i bibliografin?'
    ['Få se nu...\ var kan man hitta böcker? Tänk, tänk, tänk...',
     'Det skulle ha funnits en stor byggnad full av alla möjliga olika
     böcker...',
     'Har du provat biblioteket?',
     'Om du är osäker på var biblioteket ligger, försök gå ut 
...
++ Goal 'Vad var kombinationen till förrådsrummet igen?'
    ['Va, för du inte noggranna anteckningar?',
     ...
     'Observera också att när du väl har lyckats öppna dörren en gång,
     kommer din karaktär att komma ihåg hur man gör det i framtiden också; allt du
...
++ Goal 'Hur kommer jag in i "Förråds"-rummet?'
    [
     'Du skulle inte ens vilja tänka på att gå in där när någon annan är i närheten.',
     'Du kan lyssna vid dörren för att märka om någon är i rummet.',
     ...
     'Om du har undvikit personerna i rummet genom att gå iväg varje gång
...
++ Goal 'Hur undviker jag att bli utkastad från tunnlarna av arbetarna?'
    ['Du får en liten varning när de är på väg att dyka upp.',
     'Du skulle kunna gå iväg innan de anländer.',
...
++ Goal 'Hur spårar jag kameran förbi nätverksroutern?'
    ...
    paketen kommer.',
     ...
     'Du behöver hitta kamerans adress och spåra paketen 
...
++ Goal 'Hur hittar jag en dator om jag vet dess IP-adress?'
    ['Vid det här laget måste du ha sett några arbetsorderformulär 
     av slaget Network Installer Company.  
...
++ Goal 'Jag fick arbetsordern för IP-adressen, men vad ska jag göra nu?'
    ['Du har tittat på arbetsordrar förut.',
     ...
     'Det kommer att ge dig informationen om vart du ska gå och hur du kommer in.']
...
++ Goal 'Vad är <q>hexadecimal</q>?'
    ['Det är ett talsystem med bas 16. Minns du vad du lärde
...
++ Goal 'Var hittar jag instruktioner för nätverksanalysatorn?'
    ['Vem var det som skulle använda nätverksanalysatorn?',
     'Det är inte arbetarna på gården som använder 
     nätverksanalysatorn---det är Plisnik.',
     ...
     betyder <q>packet sniffing,</q> datorjargong för att spåra flödet
     ...
     med IP-adress 8.9.10.11, skriver du in 0908090A0B.']
...
++ Goal 'Hur blir jag av med Plisnik?'
    ['Försök att prata med honom lite.',
     ...
     'Plisnik är rädd för råttor. En råtta kanske skulle skrämma bort honom.',
     'Har du hittat råttleksaken?',
     'Du kanske kan försöka visa den för Plisnik.',
     'Okej då, han är inte så rädd för en leksaksråtta. Men om du fick den
     att se levande ut?',
     'Lade du märke till att det är en handdocka?',
     'Försök trä på den på din hand och visa den för honom.',
     'Detta övertygar honom inte heller. Du kanske behöver få
     leksaksråttan att se ut som om den kan röra sig utan din hjälp.',
     ...
     'Trä råttan över leksaksbilen. Gå in i ångtunneln bredvid
...
++ Goal 'Finns det något jag behöver slå upp i ringpärmen?'
    ['Lägg märke till jobbordernummerformatet: 1234-5678.',
     ...
     'Försök slå upp numret på etiketten som är på SPY-9-kabeln.']
    
    openWhenTrue = (workOrders.described && spy9Tag.described)
    closeWhenRevealed = 'spy9-ip'
;

++ Goal 'Hur tar jag mig igenom den nord-sydliga krypgången?'
    ['Har du någon anledning att gå den vägen?',
     'Du behöver inte bekymra dig för att ta dig igenom. Det finns
     inget du behöver på den andra sidan.']
...
++ Goal 'Hur löser jag Pauls stapel (rum 42)?'
    ...
    varningarna som berättelsen visar då och då om att denna stapel
...
++ Goal 'Hur löser jag Jättekyckling-stapeln (rum 12)?'
    ['Om du har letat efter någon, kanske du kan hitta dem här.',
     ...
     'Du vill kanske läsa anteckningsboken (på dörren till rum 12)
     ...
     'Utöver detta finns det inget mer du behöver göra med denna stapel.
...
++ Goal 'Kan jag hjälpa till med Turbo Power Animals-stapeln (rum 22)?'
    ['Du har en hel del att göra på din egna stapel. Du borde förmodligen
...
++ Goal 'Kan jag hjälpa till med Turbo Power Animals-stapeln (rum 22)?'
    ['Du skulle behöva Jays hjälp, så det verkar vara mödan värt att hämta
    Turbo Power Squirrel.',
    'Utöver det bör du förmodligen fokusera på din egen uppgift att lösa 
    Brian Stamers stapel.']
...
++ Goal 'Hur löser jag <i>Honolulu 10-4</i>-stapeln (rum 24)?'
    ['Har du försökt spela spelet?',
     ...
     'Du bör förmodligen inte bekymra dig så mycket om denna stapel just nu.
...
++ Goal 'Hur löser jag brute-force-stapeln (rum 50)?'
    ['Studenterna verkar ha detta under kontroll. Du
