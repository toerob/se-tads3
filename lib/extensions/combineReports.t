...
modify DropAction
    ...
    vCorrect(str) {  return 'släpp{er|te}';  }
;
...
modify PutOnAction
    ...
    vCorrect(str) { return 'stopp{ar|ade}'; }
;
...
modify TAction
    ...
    {
        return '{Du/han} ' + vCheck(gAction.getVerbPhrase1(true, 
...
modify TIAction
    getActionDescWith(dobjText)
    {    
        return '{Du/han} '+ vCheck(gAction.getVerbPhrase2(true, 
